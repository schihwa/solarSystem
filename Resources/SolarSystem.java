...
public class SolarSystem extends JFrame {
	 ...
	 *                 LIGHT_GRAY,
	 *                 MAGENTA, ORANGE, PINK, RED, WHITE, YELLOW. Alternatively, a
	 *                 24 bit hexadecimal string representation of an RGB colour is
	 *                 also accepted, e.g. "#FF0000"
	 *                 </p>
	 */
	 ...
	 * The SolarSystem class uses <i>Polar Co-ordinates</i> to represent the
	 * location
	 * of objects in the solar system. This method operates in the same fashion as
	 * drawSolarObject, but
	 * provides additional co-ordinates to allow the programmer to use an arbitrary
	 * point about which
